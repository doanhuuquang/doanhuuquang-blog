    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="w-full p-5 justify-between bg-transparent border border-gray-300 dark:border-gray-300 hover:bg-transparent hover:text-black shadow-none"
        >
          {field.value
...
export default function ContactForm() {
  ...
  return (
    <div className="relative bg-gradient-to-br overflow-hidden from-blue-800 to-blue-500 shadow-blue-200 dark:shadow-blue-950 shadow-lg rounded-2xl">
      <div className="absolute top-0 left-0 opacity-0 lg:opacity-100 translate-x-[60%] translate-y-[40%] z-0">
        <Image
          src={"./contact-email-decoration.svg"}
          alt="Decoration"
          width={600}
          height={600}
        />
      </div>
      <div className="relative z-1 flex lg:flex-row gap-10 flex-col w-full items-center justify-between  lg:px-5 px-3 py-10">
        <div className="flex flex-col gap-15 justify-between w-full text-white">
          <div className="flex flex-col gap-5">
            ...
            {/* Subtitle */}
            <p>
              Liên hệ ngay với chúng tôi để nhận được tư vấn miễn phí, tư vấn
              giải pháp công nghệ cho bạn.
            </p>
          </div>
          {/* Infor */}
          <div className="flex flex-col gap-5">
